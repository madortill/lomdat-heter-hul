...
const questions = [
  ...
  },
  {
    ...
    title: 'בסמכות מי להמליץ ולאשר יציאה לחו"ל למשרתי היחידה בשגרה ובמלחמה?',
    correctAnswer: 4,
    answers: [
      "לא עושים כלום",
      "מעדכנים רק את החייל",
      "ממתינים לסיום החופשה",
      'חיילי חובה- המלצת מפקד ישיר, אישור מפקד בדרגת רס"ן ומעלה, במלחמה מפקד בדרגת אל "מ <br> אנשי קבע- המלצת מפקד ישיר, אישור מפקד בדרגת סא"ל ומעלה עבור נגדים וקצינים עד דרגת רס"ן,במלחמה מפקד בדרגת אל"מ.',
    ],
  },
];
